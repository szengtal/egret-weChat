...
export class GameUtils {
	...
	*/
	public static hitTest(obj1: gameMain.HeroObject, obj2: egret.DisplayObject,testContain?:egret.Sprite): boolean {
		if (obj1 == undefined) { 
			return false; 
		}
		if (obj2 == undefined) { return false; }
		uniLib.DisplayUtils.removeAllChildren(testContain)
		// console.log("基于矩形的碰撞检测k开始开始");


		var rect1: egret.Rectangle = obj1._getContentBounds();
		var rect1:egret.Rectangle = new egret.Rectangle(0,0,rect1.width,rect1.height)

		var rect2: egret.Rectangle = obj2.getBounds();
		// console.log("基于矩形的碰撞检测1",rect1);
	//	console.log("基于矩形的碰撞检测1",rect1.height);
		// console.log("基于矩形的碰撞检测1",obj1.y);
		// console.log("基于矩形的碰撞检测2",obj2.y);
	...
	// 	console.log("基于矩形的碰撞检测22",obj2.y);
        ...
        shp.graphics.drawRect( obj1.x-rect1.width/2, obj1.y-rect1.height/2, rect1.width, rect1.height );
		...
		rect1.x = obj1.x-rect1.width/2;
		rect1.y = obj1.y-rect1.height/2;
		rect2.x = obj2.x;
		rect2.y = obj2.y;
